 ...
 *   room-add    &lt;name&gt;                 Create a new room
 *   room-remove &lt;roomId&gt;              Close and remove a room
 *   room-state  &lt;roomId&gt; &lt;state&gt;      Change room state
 *
 *   players                            List all players
 *   kick        &lt;playerId&gt; [reason]    Kick a player
 *   disconnect  &lt;playerId&gt;             Disconnect a player
 *
 *   bans                               Show all ban lists
 *   ban         &lt;playerId&gt; [reason]    Ban a player
 *   unban       &lt;displayName&gt;          Unban by display name
 *   ban-ip      &lt;ip&gt;                   Ban an IP address
 *   unban-ip    &lt;ip&gt;                   Unban an IP address
 *
 *   broadcast   [roomId|-] &lt;tag&gt; [msg] Broadcast a custom event
 *   send        &lt;playerId&gt; &lt;tag&gt; [msg] Send event to player
 *
 *   stop  (exit / quit)                Gracefully stop the server
 * </pre>
 */
public class Main {
        ...
        switch (cmd) {
            ...
            case "broadcast": {
                ...
                org.json.JSONObject payload = msg != null
                        ? new org.json.JSONObject().put("message", msg) : null;
