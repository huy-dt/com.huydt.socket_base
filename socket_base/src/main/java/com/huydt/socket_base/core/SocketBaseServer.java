...
import com.huydt.socket_base.network.BaseWebSocketServer;
import com.huydt.socket_base.network.MessageDispatcher;
import com.huydt.socket_base.network.TcpClientHandler;
...
/**
 * Entry-point for the {@code com.huydt.socket_base} SDK.
 *
 * <h3>Minimal usage</h3>
 * <pre>
...
public class SocketBaseServer {
    ...
    public SocketBaseServer(ServerConfig config, MessageDispatcher dispatcher) {
        ...
        if (config.wsPort > 0 &&
            ...
            this.wsServer = new BaseWebSocketServer(config.wsPort, dispatcher);
        }
    }
